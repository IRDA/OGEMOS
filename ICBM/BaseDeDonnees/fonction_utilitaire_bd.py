        ...
        for line in file:
            if index != 0:
                ...
                entry = TableDesMunicipalites(code_geographique_municipalite=str(attributes[0].replace("\"", "")),
                                              ...
                                              rendement_ble=float(attributes[3]),
                                              rendement_mais_fourrager=float(attributes[4]),
                                              rendement_orge=float(attributes[5]),
                                              rendement_mais_grain=float(attributes[6]),
                                              rendement_soya=float(attributes[7]),
                                              rendement_haricot=float(attributes[8]),
